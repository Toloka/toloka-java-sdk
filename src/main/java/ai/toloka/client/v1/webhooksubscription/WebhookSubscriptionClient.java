...
public interface WebhookSubscriptionClient {
    ...
    BatchCreateResult<WebhookSubscription> upsertWebhookSubscriptions(List<WebhookSubscription> webhookSubscriptions);

    SearchResult<WebhookSubscription> findWebhookSubscriptions(WebhookSubscriptionSearchRequest request);
